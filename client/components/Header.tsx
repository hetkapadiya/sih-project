    ...
    <header className="w-full bg-card/80 backdrop-blur-sm">
      <div className="container mx-auto flex items-center justify-between py-4">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <Link to="#about" className="text-sm text-foreground hover:text-primary-foreground">About</Link>
          <Link to="#events" className="text-sm text-foreground hover:text-primary-foreground">Events</Link>
          <Link to="#benefits" className="text-sm text-foreground hover:text-primary-foreground">Benefits</Link>
          <Link to="#contact" className="text-sm text-foreground hover:text-primary-foreground">Contact</Link>
        </nav>
