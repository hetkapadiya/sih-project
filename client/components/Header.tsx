        ...
        <div className="flex items-center gap-3">
          ...
          {!user ? (
            ...
            <div className="flex items-center gap-4">
              ...
              <RouterLink to={user.role === "admin" ? "/admin/dashboard" : user.role === "student" ? "/dashboard/student" : user.role === "faculty" ? "/dashboard/faculty" : "/dashboard/alumni"} className="px-3 py-2 rounded-md text-sm bg-card text-card-foreground border">Dashboard</RouterLink>
