    ...
    <header className="w-full shadow-sm bg-primary text-primary-foreground">
      <div className="container mx-auto py-2 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {!user ? (
            <>
              <Link to="/student-login" className="hidden sm:inline-block px-3 py-2 rounded-md text-sm bg-secondary text-secondary-foreground">Student</Link>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to={user.role === "admin" ? "/admin/dashboard" : user.role === "student" ? "/dashboard/student" : "/dashboard/alumni"} className="px-3 py-2 rounded-md text-sm bg-card text-card-foreground border">Dashboard</Link>
