export default function Footer() {
  return (
    <footer className="w-full bg-primary text-primary-foreground mt-12">
      <div className="container mx-auto py-12 grid md:grid-cols-4 gap-6">
        <div>
          ...
          <p className="text-sm text-primary-foreground/90 mt-3">
            Institute of Excellence — Connecting alumni and students through
            events, mentorship and support.
          </p>
        </div>
      ...
      <div className="border-t border-primary/20 py-4 text-center text-sm text-primary-foreground/80">
