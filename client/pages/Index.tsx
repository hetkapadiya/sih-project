...
export default function Index() {
  ...
  return (
    <div>
        ...
        <div className="container mx-auto flex flex-col lg:flex-row items-center gap-10">
          <div className="lg:w-2/3">
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl">
              Connecting generations — events, mentorship, careers, and
              opportunities for alumni and students of the Institute.
            </p>

            <div className="mt-6 flex flex-wrap gap-3">
              <a
                href="/register"
                className="px-5 py-3 rounded-md bg-white text-foreground border border-[rgb(232,234,238)]"
              >
                Register
              </a>
            </div>
          ...
          <aside>
            <div className="p-6 bg-card rounded-md shadow-sm">
              ...
              <div className="mt-3">
                ...
                />
                <button className="mt-3 w-full rounded-md bg-accent text-accent-foreground px-3 py-2">
                  Subscribe
                </button>
              </div>
            </div>
      ...
      <section
        id="gallery"
        className="py-12 bg-[linear-gradient(180deg,rgba(0,0,0,0.02),transparent)]"
      >
        <div className="container mx-auto">
          ...
          <div className="grid gap-4 grid-cols-2 md:grid-cols-4">
            ...
            />
            <img
              src="https://images.unsplash.com/photo-1496302662116-35cc4f36df92?q=80&w=600&auto=format&fit=crop"
              alt="gallery 2"
              className="w-full h-40 object-cover rounded-md"
            />
            <img
              src="https://images.unsplash.com/photo-1523580846011-d3a5bc25702b?q=80&w=600&auto=format&fit=crop"
              alt="gallery 3"
              className="w-full h-40 object-cover rounded-md"
            />
            <img
      ...
      <section id="alumni-map" className="py-12">
        <div className="container mx-auto">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            See where our alumni are around the world. Bubble size indicates
