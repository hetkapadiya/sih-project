      ...
      <section className="hero-gradient text-white py-24">
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-10">
          <div className="md:w-7/12">
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight drop-shadow">AlumniHub — Where alumni and students connect</h1>
            <p className="mt-4 max-w-xl text-lg text-white/90">Join a thriving community of graduates and current students. Discover events, mentoring, career services, and ways to give back to your institute.</p>

            <div className="mt-8 flex items-center gap-4">
              <a href="/alumni-login" className="inline-flex items-center gap-2 px-5 py-3 rounded-md bg-primary text-primary-foreground font-semibold shadow-lg">Alumni Login</a>
              <a href="/student-login" className="inline-flex items-center gap-2 px-5 py-3 rounded-md bg-white text-foreground font-medium border">Student Portal</a>
            </div>

            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-white/10 p-4 rounded-md">
                <h4 className="font-semibold">Events</h4>
                <p className="text-sm text-white/90 mt-1">Reunions, webinars, and local chapter meetups.</p>
              </div>
              <div className="bg-white/10 p-4 rounded-md">
                <h4 className="font-semibold">Mentorship</h4>
                <p className="text-sm text-white/90 mt-1">Connect with alumni mentors across industries.</p>
              </div>
              <div className="bg-white/10 p-4 rounded-md">
                <h4 className="font-semibold">Giving</h4>
                <p className="text-sm text-white/90 mt-1">Support scholarships and campus projects.</p>
              </div>
            </div>
          </div>
          ...
          <div className="md:w-5/12">
            <div className="bg-card p-6 rounded-xl shadow-xl">
              <h3 className="text-xl font-semibold mb-2 text-foreground">Quick Access</h3>
              <p className="text-sm text-muted-foreground mb-4">Sign in quickly to access personalized content.</p>

              <div className="grid grid-cols-1 gap-3">
                <a href="/alumni-login" className="w-full text-center px-4 py-3 rounded-md bg-primary text-primary-foreground">Alumni Login</a>
                <a href="/student-login" className="w-full text-center px-4 py-3 rounded-md bg-white text-foreground border">Student Portal</a>
              </div>

              <div className="mt-6">
                <h4 className="font-medium">Upcoming Event</h4>
                <p className="text-sm text-muted-foreground">Alumni Reunion — 25th July · Main Auditorium</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <aside>
            <div className="p-4 bg-card rounded-md">
              ...
              <div className="mt-3">
                ...
                <button className="mt-3 w-full rounded-md bg-primary text-primary-foreground px-3 py-2">Subscribe</button>
              </div>
            </div>
          </aside>
        </div>
