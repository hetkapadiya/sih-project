...
export default function UsersSection() {
  ...
  const filtered = users.filter((u) => {
    ...
    if (verify !== "all" && (verify === "verified" ? !u.verified : u.verified))
      return false;
    return true;
  });
    ...
    <div className="grid gap-4">
      <Card>
        ...
        <CardContent className="grid gap-3 md:grid-cols-5">
          <Input
            placeholder="Search by name, email, department, skills, location"
            value={q}
                ...
                <TableRow key={u.id}>
                  ...
                  <TableCell className="space-x-2">
                    ...
                    <Button
                      ...
                      variant="secondary"
                      onClick={() => {
                        const r = resetPassword(u.id);
                        logAudit(
                          user?.email || "admin",
                          "reset_password",
                          u.email,
                        );
                        alert(`Reset link: ${r.link}`);
                      }}
                    >
                      Reset Password
                    </Button>
                    <Button
                      ...
                      onClick={() => {
                        ...
                        logAudit(
                          user?.email || "admin",
                          !u.disabled ? "disable_user" : "enable_user",
                          u.email,
                        );
                        refresh();
                      }}
